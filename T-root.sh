...
sleep 0.0
echo
printf "$A[$b1+$A]${b1} Creador:$a     Angel Del Villar\n"
printf "$A[$b1+$A]${b1} Herramienta:$a T-root\n"
printf "$A[$b1+$A]${b1} GitHub:$a      https://github.com/Angel-iluminaty\n"
printf "$A[$b1+$A]${b1} Telegram:$a     https://t.me/+eZc15Eln-lMzZmZh\n"
echo
sleep 0.3
exit
}
...
printf "$A[$b1+$A]${b1} GitHub:$a  https://github.com/Angel-iluminaty\n"
sleep 0.3
printf "$A[$b1+$A]${b1} Telegram:$a https://t.me/+eZc15Eln-lMzZmZh$b\n"
sleep 0.3
